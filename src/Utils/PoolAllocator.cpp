...
PoolAllocator::PoolAllocator(size_t bucketSize, size_t numberOfBuckets) : m_bufferSize(bucketSize* numberOfBuckets), m_bucketSize(bucketSize)
{
...
size_t PoolAllocator::getMaxSize()
{

    return m_bufferSize;
}

size_t PoolAllocator::getBucketSize()
{
